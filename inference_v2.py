...
class Inference: 
    def __init__(self, args): 
        ...
        df = pd.DataFrame(columns=['Specie', 'Tree', 'ID', 'HD', "Kappa_0.0", "Kappa_0.1", "Kappa_0.2", "Kappa_0.3", "Kappa_0.4", "Kappa_0.5", "Dice_0.0", "Dice_0.1", "Dice_0.2", "Dice_0.3", "Dice_0.4", "Dice_0.45", "Dice_0.5", "Dice_0.6", "Dice_0.65", "Dice_0.7"])
        ...
        for idx, (tree_id, tree_path) in enumerate(zip(tree_img_list, tree_path_list)): 
            ...
            for _ in range(args.iterations): 
                for img_seq, img_name_seq, mask_seq, mask_name_seq in tqdm(zip(img_seq_list, img_name_seq_list, mask_seq_list, mask_name_seq_list), total=len(img_seq_list)): 
                    ...
                    FP_5.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_5[:, :, :, :, 0]), tf.int32))
                    FN_5.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_5[:, :, :, :, 0]), tf.int32))
                    TP_5.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_5[:, :, :, :, 0]), tf.int32)) 
                    TN_5.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_5[:, :, :, :, 0]), tf.int32))
                    
                    FP_4.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_4[:, :, :, :, 0]), tf.int32))
                    FN_4.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_4[:, :, :, :, 0]), tf.int32))
                    TP_4.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_4[:, :, :, :, 0]), tf.int32)) 
                    TN_4.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_4[:, :, :, :, 0]), tf.int32))

                    FP_3.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_3[:, :, :, :, 0]), tf.int32))
                    FN_3.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_3[:, :, :, :, 0]), tf.int32))
                    TP_3.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_3[:, :, :, :, 0]), tf.int32)) 
                    TN_3.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_3[:, :, :, :, 0]), tf.int32))

                    FP_2.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_2[:, :, :, :, 0]), tf.int32))
                    FN_2.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_2[:, :, :, :, 0]), tf.int32))
                    TP_2.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_2[:, :, :, :, 0]), tf.int32)) 
                    TN_2.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_2[:, :, :, :, 0]), tf.int32))

                    FP_1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_1[:, :, :, :, 0]), tf.int32))
                    FN_1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_1[:, :, :, :, 0]), tf.int32))
                    TP_1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_1[:, :, :, :, 0]), tf.int32)) 
                    TN_1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_1[:, :, :, :, 0]), tf.int32))
                    
                    FP_0.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_0[:, :, :, :, 0]), tf.int32))
                    FN_0.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_0[:, :, :, :, 0]), tf.int32))
                    TP_0.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_0[:, :, :, :, 0]), tf.int32)) 
                    TN_0.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_0[:, :, :, :, 0]), tf.int32))

                    meaniou.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_copy[:, :, :, :, 0]), tf.int32))  
                    meaniou0.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_0[:, :, :, :, 0]), tf.int32))
                    meaniou1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_1[:, :, :, :, 0]), tf.int32))
                    meaniou2_1.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_2[:, :, :, :, 0]), tf.int32))
                    meaniou2.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_3[:, :, :, :, 0]), tf.int32)) 
                    meaniou3.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_4[:, :, :, :, 0]), tf.int32))
                    meaniou4.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_45[:, :, :, :, 0]), tf.int32))
                    meaniou5.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_5[:, :, :, :, 0]), tf.int32)) 
                    meaniou6.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_6[:, :, :, :, 0]), tf.int32)) 
                    meaniou7.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_65[:, :, :, :, 0]), tf.int32))
                    meaniou8.update_state(tf.cast(y_true[:, :, :, :, 0], tf.int32), tf.cast(tf.math.round(pred_7[:, :, :, :, 0]), tf.int32))

                    fc_0 = (((TN_0.result().numpy() + FN_0.result().numpy()) * (TN_0.result().numpy()+FP_0.result().numpy())) + ((FP_0.result().numpy()+TP_0.result().numpy())*(FN_0.result().numpy()+TP_0.result().numpy()))) / (TP_0.result().numpy() + TN_0.result().numpy() + FN_0.result().numpy() + FP_0.result().numpy())  

                    fc_1 = (((TN_1.result().numpy() + FN_1.result().numpy()) * (TN_1.result().numpy()+FP_1.result().numpy())) + ((FP_1.result().numpy()+TP_1.result().numpy())*(FN_1.result().numpy()+TP_1.result().numpy()))) / (TP_1.result().numpy() + TN_1.result().numpy() + FN_1.result().numpy() + FP_1.result().numpy())  
                    
                    fc_2 = (((TN_2.result().numpy() + FN_2.result().numpy()) * (TN_2.result().numpy()+FP_2.result().numpy())) + ((FP_2.result().numpy()+TP_2.result().numpy())*(FN_2.result().numpy()+TP_2.result().numpy()))) / (TP_2.result().numpy() + TN_2.result().numpy() + FN_2.result().numpy() + FP_2.result().numpy())  
                    
                    fc_3 = (((TN_3.result().numpy() + FN_3.result().numpy()) * (TN_3.result().numpy()+FP_3.result().numpy())) + ((FP_3.result().numpy()+TP_3.result().numpy())*(FN_3.result().numpy()+TP_3.result().numpy()))) / (TP_3.result().numpy() + TN_3.result().numpy() + FN_3.result().numpy() + FP_3.result().numpy())  
                    
                    fc_4 = (((TN_4.result().numpy() + FN_4.result().numpy()) * (TN_4.result().numpy()+FP_4.result().numpy())) + ((FP_4.result().numpy()+TP_4.result().numpy())*(FN_4.result().numpy()+TP_4.result().numpy()))) / (TP_4.result().numpy() + TN_4.result().numpy() + FN_4.result().numpy() + FP_4.result().numpy())  
                    
                    fc_5 = (((TN_5.result().numpy() + FN_5.result().numpy()) * (TN_5.result().numpy()+FP_5.result().numpy())) + ((FP_5.result().numpy()+TP_5.result().numpy())*(FN_5.result().numpy()+TP_5.result().numpy()))) / (TP_5.result().numpy() + TN_5.result().numpy() + FN_5.result().numpy() + FP_5.result().numpy())  
                    
                    Kappa_0 = ((TP_0.result().numpy()+TN_0.result().numpy())-fc_0) / ((TP_0.result().numpy()+TN_0.result().numpy()+FN_0.result().numpy()+FP_0.result().numpy())-fc_0) 
                    Kappa_1 = ((TP_1.result().numpy()+TN_1.result().numpy())-fc_1) / ((TP_1.result().numpy()+TN_1.result().numpy()+FN_1.result().numpy()+FP_1.result().numpy())-fc_1) 
                    Kappa_2 = ((TP_2.result().numpy()+TN_2.result().numpy())-fc_2) / ((TP_2.result().numpy()+TN_2.result().numpy()+FN_2.result().numpy()+FP_2.result().numpy())-fc_2) 
                    Kappa_3 = ((TP_3.result().numpy()+TN_3.result().numpy())-fc_3) / ((TP_3.result().numpy()+TN_3.result().numpy()+FN_3.result().numpy()+FP_3.result().numpy())-fc_3) 
                    Kappa_4 = ((TP_4.result().numpy()+TN_4.result().numpy())-fc_4) / ((TP_4.result().numpy()+TN_4.result().numpy()+FN_4.result().numpy()+FP_4.result().numpy())-fc_4) 
                    Kappa_5 = ((TP_5.result().numpy()+TN_5.result().numpy())-fc_5) / ((TP_5.result().numpy()+TN_5.result().numpy()+FN_5.result().numpy()+FP_5.result().numpy())-fc_5) 
                    ...
                    df.loc[count, "Dice_0.0"] = ((2*(meaniou0.result().numpy())) / (meaniou0.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.1"] = ((2*(meaniou1.result().numpy())) / (meaniou1.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.2"] = ((2*(meaniou2_1.result().numpy())) / (meaniou2_1.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.3"] = ((2*(meaniou2.result().numpy())) / (meaniou2.result().numpy() + 1))*100 
                    df.loc[count, "Dice_0.4"] = ((2*(meaniou3.result().numpy())) / (meaniou3.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.45"] = ((2*(meaniou4.result().numpy())) / (meaniou4.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.5"] = ((2*(meaniou5.result().numpy())) / (meaniou5.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.6"] = ((2*(meaniou6.result().numpy())) / (meaniou6.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.65"] = ((2*(meaniou7.result().numpy())) / (meaniou7.result().numpy() + 1))*100
                    df.loc[count, "Dice_0.7"] = ((2*(meaniou8.result().numpy())) / (meaniou8.result().numpy() + 1))*100
            ...
            if args.save_img:
                ...
                os.makedirs(os.path.join(args.output, args.species, tree_id, 'preds_thresh'), exist_ok=True) 
                ...
                for i in thresh_: 
                    os.makedirs(os.path.join(args.output, args.species, tree_id, f'preds_{i}'), exist_ok=True) 
                for name in pred_dict.keys(): 
                    ...
                    if result.shape[0]>10: 
                        ...
                        for i in thresh_: 
                            cv2.imwrite(os.path.join(args.output, args.species, tree_id, f'preds_{i}', name), ((preds>i)*255).astype(np.uint8)) 

                print(" * images saved")
        os.makedirs("./output/", exist_ok=True) 
        df.to_csv(f"./output/{args.model}_{args.species}_metrics_thresholds.csv", index=False) 
